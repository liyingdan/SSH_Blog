...
<script id="mytp2" type="text/html">
...
<script>
    ...
    if (parentid != null) {
        ...
        $.post("${pageContext.request.contextPath}/article_getCategory.action", {"parentid":parentid}, function (data) {
            var html = template('mytp2', {list: data});
   ...
   $("body").on("click",".category_btn",function () {
    ...
    function getPageList(currPage,parentid,cid) {
        $.post("${pageContext.request.contextPath}/web_getPageList.action", {currPage: currPage,parentid:parentid,cid:cid}, function (data) {
            console.log(data);
