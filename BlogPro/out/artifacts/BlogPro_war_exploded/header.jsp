...
<section id="lk_blog_one">
    ...
    <div class="one-right">
        <div class="headerPic" style="width: 150px;height: 150px;background-color: red;border-radius: 50%">
            <img src="images/headerPic.jpg" alt="" style="width: 150px;height: 150px; border-radius: 50%">
        </div>
        <span>一只狐狸，它坐在沙丘上</span>
        <div style="position: relative;" class="one-bottom">
            <a href="" style="width: 50px;height: 20px;background-color: red;">关注我</a>
        </div>
    </div>
</section>
