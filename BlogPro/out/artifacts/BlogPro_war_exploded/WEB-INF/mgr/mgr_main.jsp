...
<div class="goods_list">
    ...
    <s:iterator value="list" var="article">
        <ul class="list_goods_ul">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/article_edit.action?article_id=<s:property value="#article.article_id"/>">
...
<script>
    ...
    $("#add").click(function () {
        // alert("aaa");
        $(window).attr('location','${pageContext.request.contextPath }/location_add.action');
    });
